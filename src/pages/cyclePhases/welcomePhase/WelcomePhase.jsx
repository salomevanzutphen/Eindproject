    ...
    return (
        <div className="welcome-phase-wrapper">
            ...
            <div className="welcome-info">
                <p>Welcome to your personalised cycle tracker. When activated, you'll be able to look into the future & see when your phases occur. During each phase, you'll receive all the tips & advice to help you make the most out of it!

                </p>
                <h3>Let's get started!</h3>
                <ul>
                    <li>Click on the ‘Calendar’ button.
                        </li>
